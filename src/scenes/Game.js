...
export class Game extends Scene {
  ...
  create() {
    ...
    townhall.on("pointerover", () => {
      townhall.setScale(0.32);
    });
    townhall.on("pointerout", () => {
      townhall.setScale(0.3);
    });
    ...
    const handleAddLiquidityClick = () => {
      ...
      // Add USDC amount input field
      const usdcInput = this.add.dom(0, -100).createFromCache("usdcInput");
      addLiquidityPopup.add(usdcInput);

      // Add Gold Coin amount input field
      const goldCoinInput = this.add.dom(0, -50).createFromCache("goldCoinInput");
      addLiquidityPopup.add(goldCoinInput);
      ...
      // Add content and functionality to the add liquidity popup as needed
    ...
    const handleBuyButtonClick = (button, buildingSprite) => {
      ...
      this.time.delayedCall(1000, () => {
        ...
        const building = this.add.sprite(512, 384, buildingSprite); // Adjust position as needed
        building.scale = 0.4;
      });
    };
